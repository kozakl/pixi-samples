...
gulp.task('makeAtlas', function() {
    ...
    es.concat(
        ...
        es.concat(
            moveFont('./assets/fonts/@0.5x/*.png',  PATH_05x),
            moveFont('./assets/fonts/@0.75x/*.png', PATH_075x),
            moveFont('./assets/fonts/@1x/*.png',    PATH_1x),
            moveFont('./assets/fonts/@1.25x/*.png', PATH_125x),
            moveFont('./assets/fonts/@1.5x/*.png',  PATH_15x),
            moveFont('./assets/fonts/@1.75x/*.png', PATH_175x)
        ).on('end', function() {
