...
function Main()
{
    ...
    Main.scaleAsset = 1//DetectDevice.isDesktop() ? MathUtil.clamp(Math.round(window.devicePixelRatio * 2) / 2, 0.5, 1.75) :
...
Main.prototype.onLoadAssets = function(loader, res)
{
    ...
    var text = new PIXI.extras.BitmapText('bitmap\ntext!!!', {font:'50px Arial50', align:'center'});
